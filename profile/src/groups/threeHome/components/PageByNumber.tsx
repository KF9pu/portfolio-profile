...
const PageByNumber: FC<PageByNumberProps> = ({}) => {
  ...
  return (
    <div
      className={cls(
        "flex flex-col",
        "fixed top-0 right-0 md:right-[20px]",
        "bg-tertiary",
        "w-[90vw] md:w-[30vw] h-[calc(100vh-160px)] md:h-auto md:min-w-[320px] md:max-w-[420px]",
        "border border-primary rounded-xl",
        "transition-all duration-500",
        "pl-[24px] py-[24px] md:px-[24px] md:pt-[48px] md:pb-[56px]",
        "overflow-y-scroll",
        "break-all",
